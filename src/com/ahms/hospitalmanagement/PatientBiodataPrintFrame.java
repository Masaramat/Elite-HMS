...
public class PatientBiodataPrintFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PatientBiodataPrintFrame frame = new PatientBiodataPrintFrame("");
	 ...
	 * Create the frame.
	 */
	public PatientBiodataPrintFrame(String file_no) {
	...
	public void showReport(String hospital_no){
		String reportSource = "/com/ahms/hospitalmanagement/PatientBiodata.jrxml";
		PatienBiodataBeanFactory pbbf = new PatienBiodataBeanFactory();		
				
		try{
			ArrayList<PatientBiodata> pb = pbbf.getPatientBiodata(hospital_no);						
